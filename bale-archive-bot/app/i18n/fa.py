...
def bot_added_ask_role(group_title: str) -> str:
    return (
        ...
        "یکی از مدیران گروه باید بازو را مستقیماً به‌عنوان مدیر (ادمین) اضافه کند "
        "تا متن عادی و فوروارد بدون منشن دریافت شود.\n"
...
def bot_join_needs_direct_admin(group_title: str) -> str:
    return (
        ...
        "یکی از مدیران گروه باید بازو را مستقیماً از بخش «مدیران ← افزودن مدیر» اضافه کند؛ "
...
def research_set_done(group_title: str, bot_username: str | None = None) -> str:
    ...
    return (
        ...
        "مالک‌بودن لازم نیست؛ هر مدیر همان گروه می‌تواند این کار را انجام دهد.\n"
...
def research_need_admin(group_title: str, bot_username: str | None = None) -> str:
    ...
    return (
        ...
        "\n"
        "اگر پیام عادی یا فوروارد نمی‌رسد، یکی از مدیران گروه بازو را یک‌بار حذف کند و از مسیر "
