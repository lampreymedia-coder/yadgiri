...
BOT_READY_PING = (
    ...
    "\n"
    "اگر در گروه جواب نمی‌دهد، بله پیام‌های عادی گروه را به ربات نمی‌رساند "
    "مگر اینکه ربات را صدا بزنید.\n"
    "\n"
    "الان یکی از این دو کار را بکنید — همان لحظه جواب می‌گیرید:\n"
    "• دکمه «افزودن به گروه» را بزنید\n"
    "• یا داخل گروه بنویسید: /start"
)
