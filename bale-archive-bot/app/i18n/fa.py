...
GROUP_HELLO = (
    "سلام، من ربات آرشیو هستم و در این گروه فعالم.\n"
    "\n"
    "هر پیامی اینجا بفرستید، زیر همان پیام می‌پرسم ذخیره شود یا نه."
)

BOT_READY_PING = (
    "ربات روشن شد.\n"
    "\n"
    "الان داخل گروهی که ربات را ادمین کرده‌اید بنویسید:\n"
    "/start\n"
    "\n"
    "باید زیر پیامتان دکمه‌های «گروه رصد / گروه آرشیو» ظاهر شود.\n"
    "بعد هر محتوایی بفرستید، می‌پرسم با هشتگ ذخیره شود یا نه."
)
